...
public class HiddenObjectsServiceImpl implements HiddenObjectsApiService {
    ...
    public synchronized ru.urvanov.virtualpets.server.controller.api.domain.HiddenObjectsGame joinGame(
        ...
        User user = userDao.findById(userPetDetails.userId()).orElseThrow();
    ...
    public synchronized ru.urvanov.virtualpets.server.controller.api.domain.HiddenObjectsGame collectObject(
        ...
        Integer userId = userPetDetails.userId();
        ...
        for (HiddenObjectsPlayer player : players) {
            if (player != null) {
                ...
                if (!fullPet.getFoods().containsKey(foodId)) {
                    ...
                    food.setPet(fullPet);
                    food.setFood(foodDao.getReferenceById(foodId));
                    food.setFoodCount(1);
                ...
                if (buildingMaterialId != null) {
                    ...
                    if (petBuildingMaterial == null) {
                        ...
                        petBuildingMaterial
                                .setBuildingMaterial(buildingMaterialDao.getReferenceById(buildingMaterialId));
                ...
                if (drinkId != null) {
                    ...
                    if (petDrink == null) {
                        ...
                        petDrink.setDrink(drinkDao.getReferenceById(drinkId));
                ...
                if (bookId != null && !bookFound) {
                    ...
                    books.add(bookDao.findById(bookId).orElseThrow());
                    reward.setBookId(bookId);
                }
