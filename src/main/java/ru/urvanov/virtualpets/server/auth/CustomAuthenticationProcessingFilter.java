...
public class CustomAuthenticationProcessingFilter
                    ...
                    public void onAuthenticationFailure(
                        ...
                        problemDetail.setDetail(
                                exception.getLocalizedMessage() == null
                                        ...
                                        : exception
                                                .getLocalizedMessage());
                        response.getWriter().write(objectWriter
                                .writeValueAsString(problemDetail));
                    }
    ...
    public Authentication attemptAuthentication(
        ...
        LoginArg loginArg = new LoginArg(creds.host(), creds.login(),
                null, creds.version());
        request.setAttribute("loginArg", loginArg);
